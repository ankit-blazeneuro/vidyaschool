  ...
  return (
    <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6">
      ...
      <section className="rounded-2xl bg-zinc-100 dark:bg-[#121212] mx-4 lg:mx-6 overflow-hidden">
        {/* Heading row — px-6 pt-5 pb-4 matches real component */}
        <div className="px-6 pt-5 pb-4">
          <Skeleton className="h-5 w-14 rounded-md bg-zinc-200 dark:bg-zinc-800 mb-4" />
        </div>

        {/* Horizontal scroll — overflow-x-auto, -mr-6, last:mr-6 matches real component */}
          ...
          {[...Array(3)].map((_, i) => (
            ...
            >
              ...
              <div className="px-5 pb-3 flex flex-col gap-2">
                {/* bullet items — dot uses mt-[7px] to align with text top */}
                {[...Array(3)].map((_, j) => (
              ...
              {/* Bottom gradient fade overlay — exact match */}
      ...
      {/* ── StudentWidgets: 2-col (Tasks + Scratch Pad) ── */}
