...
export default function LibrarianNoticePage() {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 px-6 lg:px-8">
        <div className="flex flex-col gap-1.5">
          ...
          <p className="text-muted-foreground text-sm max-w-2xl leading-relaxed">
            Announce book alerts, scheduling updates, library hours, or co-curricular book fairs to class channels.
          </p>
        </div>
      ...
      {isCreating ? (
        ...
        <div className="px-6 lg:px-8 max-w-3xl">
          <form onSubmit={handlePostNotice} className="rounded-xl border border-border bg-card/40 p-6 flex flex-col gap-5 shadow-sm">
            <h2 className="text-lg font-bold text-foreground">Post Library Announcement</h2>
            ...
            <div className="space-y-1.5">
              ...
              <Input
                id="notice-title"
                type="text"
                placeholder="e.g. New arrival of Science books in Library"
                value={newTitle}
