...
import { Eye, EyeOff, RefreshCw, Smartphone, CheckCircle2, Loader2, KeyRound } from "lucide-react"
          ...
          <div className="w-full max-w-sm space-y-6">
            ...
            <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
              <TabsList className="grid w-full grid-cols-2 bg-muted p-1 rounded-xl">
                <TabsTrigger value="form" className="rounded-lg text-xs font-semibold gap-2 py-1.5">
                  <KeyRound className="h-3.5 w-3.5" />
                  Email & Password
                </TabsTrigger>
                <TabsTrigger value="qr" className="rounded-lg text-xs font-semibold gap-2 py-1.5">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" strokeWidth="1.5" className="solar solar-qr-code-bold-duotone h-3.5 w-3.5">
              ...
              <TabsContent value="qr" className="pt-4">
                <div className="flex flex-col items-center gap-5">
                    ...
                    <div className="w-[190px] h-[190px] flex items-center justify-center">
                      ...
                      {qrStatus === "active" && qrToken && (
                        <div className="relative">
                          ...
                          />
                          {/* Minimalist monochrome scan line */}
                          <div className="absolute inset-0 overflow-hidden rounded pointer-events-none">
                            <div
                              className="absolute left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-foreground to-transparent opacity-70"
                  ...
                  <p className="text-[11px] text-muted-foreground text-center max-w-[240px]">
                    Open <strong>VidyaSchool App</strong> → Sidebar → <strong>QR Login</strong> to scan
                  </p>
                </div>
              </TabsContent>
            </Tabs>

            {/* ── Social Login Row (Google | GitHub | QR Code) ────────────────── */}
            <div className="space-y-4 pt-2">
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <Button
                  ...
                  className={cn(
                    "h-10 border-border bg-background hover:bg-muted text-foreground transition-all duration-200",
                    activeTab === "qr" && "bg-muted border-foreground/40 shadow-xs"
                  )}
